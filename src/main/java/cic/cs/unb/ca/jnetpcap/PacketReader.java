...
public class PacketReader {
        ...
        try {
            ...
            if (packet.hasHeader(ipv4)) {
                ...
                if (packet.hasHeader(this.tcp)) {
                    ...
                    /*
                     * logger.debug("other packet Ethernet -> {}"+ packet.hasHeader(new
                     * Ethernet()));
                    ...
                    for (int i = 0; i < headerCount; i++) {
                        ...
                        // logger.debug("getIpv4Info: {} --description: {}
     ...
     * It doesn't matter just using a static IdGenerator for realtime PcapPacket
     * reading
     */
