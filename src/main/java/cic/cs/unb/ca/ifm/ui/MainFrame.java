...
public class MainFrame extends JFrame {
    ...
    private void initMenu() {
        ...
        itemOffline.addActionListener(
                e -> SwingUtils.setBorderLayoutPane(getContentPane(), offLinePane, BorderLayout.CENTER));
        mnNetwork.add(itemOffline);

        JMenuItem itemRealtime = new JMenuItem("Realtime");
        itemRealtime.addActionListener(
                e -> SwingUtils.setBorderLayoutPane(getContentPane(), monitorPane, BorderLayout.CENTER));
         ...
         * itemVisual.addActionListener(actionEvent ->
         * SwingUtils.setBorderLayoutPane(getContentPane(),visualPane,BorderLayout.
         * CENTER));
